...
////// Emissive:
                ...
                return fixed4(finalColor,((pow((_baseTex_var.a*_maskTex_var.r),_alphaDensity)*_alphaPower)*i.vertexColor.a));
            }
            ENDCG
        }
    }
