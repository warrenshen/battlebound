...
////// Emissive:
                ...
                float3 emissive = (node_7226*_emissive*i.vertexColor.rgb*((pow(((node_8146.r+node_8146.g+node_8146.b)/3.0),_alphaDensity)*_alphaPower)*i.vertexColor.a));
