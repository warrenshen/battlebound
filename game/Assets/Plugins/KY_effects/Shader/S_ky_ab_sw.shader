...
Shader "KY/ab_sw" {
    Properties {
        ...
        _inHardness ("inHardness", Float ) = 1
...
////// Emissive:
                ...
                float3 node_7226 = saturate((saturate((pow(_MainTex_var.rgb,_outDensity)*_outHardness))-(pow(_MainTex_var.rgb,_inDensity)*_inHardness)));
                float3 emissive = (node_7226*_emissive*i.vertexColor.rgb);
