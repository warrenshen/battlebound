...
////// Emissive:
                ...
                float3 emissive = (((((((node_1808.r+node_1808.b)*node_3366)*(node_3366*(node_1808.r*node_4675.b)))*_hilightPower)*_useTexColor_var)*_hilightColor.rgb)+(_useTexColor_var*_emissive*i.vertexColor.rgb));
                float3 finalColor = emissive;
                return fixed4(finalColor,((pow(lerp( node_7000, _MainTex_var.a, _haveAlpha ),_alphaDensity)*_alphaPower)*i.vertexColor.a*saturate(pow((i.vertexColor.r+i.vertexColor.g+i.vertexColor.b),_vertColorDensity))));
            }
            ENDCG
        }
    }
