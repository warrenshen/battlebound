...
////// Lighting:
////// Emissive:
                float node_5474_if_leA = step(_uvNumber,32.0);
                float node_5474_if_leB = step(32.0,_uvNumber);
                float node_335_if_leA = step(_uvNumber,16.0);
                float node_335_if_leB = step(16.0,_uvNumber);
                float node_9756 = 32.0;
                float node_6486_if_leA = step(_uvNumber,node_9756);
                float node_6486_if_leB = step(node_9756,_uvNumber);
                float node_9176 = 16.0;
                float node_4634_if_leA = step(_uvNumber,node_9176);
                float node_4634_if_leB = step(node_9176,_uvNumber);
                float node_5287 = (_uvNumber-node_9176);
                float node_8482 = (_uvNumber-node_9756);
                float node_6486 = lerp((node_6486_if_leA*lerp((node_4634_if_leA*_uvNumber)+(node_4634_if_leB*node_5287),node_5287,node_4634_if_leA*node_4634_if_leB))+(node_6486_if_leB*node_8482),node_8482,node_6486_if_leA*node_6486_if_leB);
                ...
                float3 emissive = (node_5474*i.vertexColor.rgb*_emissive);
                float3 finalColor = emissive;
                fixed4 finalRGBA = fixed4(finalColor,(pow(i.vertexColor.a,_vertColorDensity)*(pow(node_5474,_alphaDensity)*_alphaPower)));
