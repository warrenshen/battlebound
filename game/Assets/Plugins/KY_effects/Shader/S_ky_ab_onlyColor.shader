...
////// Emissive:
                ...
                fixed4 finalRGBA = fixed4(finalColor,lerp( i.vertexColor.a, (i.vertexColor.a*lerp( node_7578, (1.0 - node_7578), _fresInv )), _useFresnel ));
