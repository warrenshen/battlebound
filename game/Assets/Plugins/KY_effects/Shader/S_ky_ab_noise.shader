...
////// Emissive:
                ...
                return fixed4(finalColor,((pow(lerp( (_MainTex_var.r*_MainTex_var.g*_MainTex_var.b), _MainTex_var.a, _haveAlpha ),_alphaDensity)*_alphaPower)*i.vertexColor.a*saturate(pow((i.vertexColor.r+i.vertexColor.g+i.vertexColor.b),_vertColorDensity))));
            }
            ENDCG
        }
    }
