...
public abstract class Card
{
    ...
    public static readonly Dictionary<string, string> ABILITY_TO_DESCRIPTION = new Dictionary<string, string>
    {
        ...
        { CARD_ABILITY_END_TURN_ATTACK_IN_FRONT_BY_TEN, "Turnover: Deal 10 damage to any creature in front" },
        { CARD_ABILITY_END_TURN_ATTACK_IN_FRONT_BY_TWENTY, "Turnover: Deal 20 damage to any creature in front" },
        { CARD_ABILITY_BATTLE_CRY_ATTACK_IN_FRONT_BY_TEN, "Warcry: Deal 10 damage to any creature in front" },
        { CARD_ABILITY_BATTLE_CRY_ATTACK_IN_FRONT_BY_TWENTY, "Warcry: Deal 20 damage to any creature in front" },
        { CARD_ABILITY_DAMAGE_TAKEN_DAMAGE_PLAYER_FACE_BY_THIRTY, "When this creature takes damage, deal 30 damage to your hero" },
        { CARD_ABILITY_BATTLE_CRY_SILENCE_IN_FRONT, "Warcry: Condemn any creature in front" },
        { CARD_ABILITY_BATTLE_CRY_HEAL_FRIENDLY_MAX, "Warcry: Restore friendly creatures to max health" },
        ...
        { CARD_ABILITY_ATTACK_DAMAGE_ADJACENT_BY_ATTACK, "When attacking also damage any creatures adjacent to the target" },
        { CARD_ABILITY_BATTLE_CRY_DAMAGE_PLAYER_FACE_BY_TWENTY, "Warcry: Sacrifice 20 health from your life total" },
        ...
        { CARD_ABILITY_BATTLE_CRY_REVIVE_HIGHEST_COST_CREATURE, "Warcry: Revive your highest cost fallen friendly creature" },
        ...
        { CARD_ABILITY_DEATH_RATTLE_ATTACK_FACE_BY_TWENTY, "Deathwish: Deal 20 damage to opponent hero" },
        { CARD_ABILITY_DEATH_RATTLE_RESUMMON, "Deathwish: Resummon this creature" },
        { CARD_ABILITY_DEATH_RATTLE_SUMMON_DUSK_DWELLERS, "Deathwish: Summon two Dusk Dweller's"},
        { CARD_ABILITY_DEATH_RATTLE_SUMMON_SUMMONED_DRAGONS, "Deathwish: Summon two Talusreaver’s" },
        ...
        { CARD_ABILITY_DAMAGE_TAKEN_ATTACK_FACE_BY_TWENTY, "Upon taking damage deal 20 damage to opponent hero" },
        { CARD_ABILITY_ICY, "Freeze opponent creatures for 1 turn after combat" },
        ...
        { CARD_ABILITY_DEATH_RATTLE_REVIVE_HIGHEST_COST_CREATURE, "Deathwish: Revive your highest cost fallen friendly creature" },
        { CARD_ABILITY_BATTLE_CRY_HEAL_FACE_TWENTY, "Warcry: Heal 20 health to your hero" },
        { CARD_ABILITY_BATTLE_CRY_ATTACK_IN_FRONT_BY_THIRTY, "Warcry: Deal 30 damage to any creature in front" },
    };
