...
public abstract class Card
{
    ...
    public static readonly Dictionary<string, string> ABILITY_TO_DESCRIPTION = new Dictionary<string, string>
    {
        ...
        { CARD_ABILITY_BATTLE_CRY_HEAL_FRIENDLY_MAX, "Warcry: Restore max health to friendly creatures" },
       ...
       // { CARD_ABILITY_BATTLE_CRY_HEAL_ALL_CREATURES_BY_FOURTY, "Warcry: Restore 40 health to all creatures" },
        { CARD_ABILITY_BATTLE_CRY_REVIVE_HIGHEST_COST_CREATURE, "Deathwish: Resurrect your highest cost fallen friendly creature" },
