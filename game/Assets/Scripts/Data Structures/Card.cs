...
public abstract class Card
{
    ...
    public static readonly Dictionary<int, string> ABILITY_CODE_TO_STRING = new Dictionary<int, string>
    {
        ...
        { 19, CARD_ABILITY_BATTLE_CRY_TAUNT_ADJACENT_FRIENDLY },
        { 20, CARD_ABILITY_LETHAL },
        { 21, CARD_ABILITY_ATTACK_DAMAGE_ADJACENT_BY_TEN },
        { 22, CARD_ABILITY_ATTACK_DAMAGE_ADJACENT_BY_ATTACK },
        { 23, CARD_ABILITY_BATTLE_CRY_DAMAGE_PLAYER_FACE_BY_TWENTY },
        { 24, CARD_ABILITY_END_TURN_BOTH_PLAYERS_DRAW_CARD },
        { 25, CARD_ABILITY_BATTLE_CRY_HEAL_ADJACENT_BY_TWENTY },
        { 26, CARD_ABILITY_BATTLE_CRY_HEAL_ADJACENT_BY_FOURTY },
        { 27, CARD_ABILITY_BATTLE_CRY_HEAL_ALL_CREATURES_BY_FOURTY },
        { 28, CARD_ABILITY_BATTLE_CRY_REVIVE_HIGHEST_COST_CREATURE },
        { 29, CARD_ABILITY_DEATH_RATTLE_DAMAGE_ALL_OPPONENT_CREATURES_BY_TWENTY },
        { 30, CARD_ABILITY_BATTLE_CRY_SILENCE_ALL_OPPONENT_CREATURES },
        { 31, CARD_ABILITY_DEATH_RATTLE_DAMAGE_ALL_CREATURES_BY_THIRTY },
    };
