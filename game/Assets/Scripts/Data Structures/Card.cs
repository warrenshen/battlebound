...
public abstract class Card
{
    ...
    public static readonly Dictionary<string, string> ABILITY_TO_DESCRIPTION = new Dictionary<string, string>
    {
        ...
        { CARD_ABILITY_EACH_KILL_DRAW_CARD, "" },
        { CARD_ABILITY_DEATH_RATTLE_ATTACK_RANDOM_THREE_BY_TWENTY, "Deathwish: Throw three bombs at random opponents dealing 10 damage each" },
        { CARD_ABILITY_END_TURN_ATTACK_IN_FRONT_BY_TEN, "Turnover: Deal 10 damage to any creature in front of this one" },
        { CARD_ABILITY_END_TURN_ATTACK_IN_FRONT_BY_TWENTY, "Turnover: Deal 20 damage to any creature in front of this one" },
        { CARD_ABILITY_BATTLE_CRY_ATTACK_IN_FRONT_BY_TEN, "Warcry: Deal 10 damage to any creature in front of this one" },
        { CARD_ABILITY_BATTLE_CRY_ATTACK_IN_FRONT_BY_TWENTY, "Warcry: Deal 20 damage to any creature in front of this one" },
        ...
        { CARD_ABILITY_DEATH_RATTLE_SUMMON_DUSK_DWELLERS, "Deathwish: Summon two Dusk Dweller creatures"},
        { CARD_ABILITY_DEATH_RATTLE_SUMMON_SUMMONED_DRAGONS, "Deathwish: Summon two Talusreaver creatures" },
