...
public class ChallengeMove
{
    ...
    public const string MOVE_CATEGORY_DEATH_RATTLE_ATTACK_RANDOM_TARGET = "MOVE_CATEGORY_DEATH_RATTLE_ATTACK_RANDOM_TARGET";
    ...
    public const string MOVE_CATEGORY_SPRAY_N_PRAY_RANDOM = "MOVE_CATEGORY_SPRAY_N_PRAY_RANDOM";
