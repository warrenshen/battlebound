...
namespace GameSparks.Editor
{
    ...
    {
        GUIContent apiSecretLabel = new GUIContent("Api Secret [DEV] [?]:", "GameSparks Api Secret can be found at https://portal.gamesparks.net");
        GUIContent apiKeyLabel = new GUIContent("Api Key [DEV] [?]:", "GameSparks Api Key can be found at https://portal.gamesparks.net");
        GUIContent apiSecretStagingLabel = new GUIContent("Api Secret [STG] [?]:", "GameSparks Api Secret can be found at https://portal.gamesparks.net");
        GUIContent apiKeyStagingLabel = new GUIContent("Api Key [STG] [?]:", "GameSparks Api Key can be found at https://portal.gamesparks.net");
        ...
        public static GameSparksSettings GetOrCreateSettingsAsset()
        {
            string fullPath = Path.Combine(
                Path.Combine(UnityAssetFolder, GameSparksSettings.gamesparksSettingsPath),
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.BeginHorizontal();
            GameSparksSettings.ApiKeyStaging = EditorGUILayout.TextField(apiKeyStagingLabel, GameSparksSettings.ApiKeyStaging).Trim();
            EditorGUILayout.EndHorizontal();

            EditorGUILayout.BeginHorizontal();
            GameSparksSettings.ApiSecretStaging = EditorGUILayout.TextField(apiSecretStagingLabel, GameSparksSettings.ApiSecretStaging).Trim();
            EditorGUILayout.EndHorizontal();
